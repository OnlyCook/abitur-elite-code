...
{
    private static readonly Dictionary<string, SqlLessonData> _database = new();
    ...
    {
        "Datenbanken", "Tabellen", "SELECT", "FROM", "WHERE", "Vergleichsoperatoren",
        "Logische Operatoren (AND, OR, NOT)", "Aliase (AS)", "Comments",
        ...
        "Primärschlüssel (PRIMARY KEY)", "Fremdschlüssel (FOREIGN KEY)", "ER-Diagramm lesen (Chen-Notation)",
        "Relationales Schema aus ER-Diagramm ableiten", "1:1 Beziehungen", "1:n Beziehungen", "n:m Beziehungen",
        ...
        "Subquery im WHERE mit IN", "Subquery im WHERE mit NOT IN", "Korrelierte Unterabfragen",
        "Subquery im FROM (abgeleitete Tabelle)", "Scalar Subquery (einzelner Wert)",
        ...
        "DISTINCT", "Variablen (SET @variable)", "Transaktionen (BEGIN, COMMIT, ROLLBACK)",
        "Ausführungsreihenfolge von SQL-Klauseln",

...
public class Level
{
    ...
    public bool NoUMLAutoScale { get; set; } // set to true for large (especially wide) diagrams
...
public static class SharedDiagrams
{
    ...
    public static string FunkModul =
        "@startuml\nclass FunkModul {\n  + FunkModul()\n  + send(cmd : String)\n  + receive() : char\n}\n@enduml";
...
:end-hint";
        ...
        return new List<Level>
        {
            ...
            new()
            {
                ...
                Prerequisites = new List<string>
                {
                    "Inheritance Basics", "Abstract Classes", "The base Keyword", "Abstract Methods",
                    "Method Overriding"
                }
            },
            new()
...
END.",
            ...
            new()
            {
                ...
                Prerequisites = new List<string>
                {
                    "While Loops", "For Loops", "Compound assignment operators", "Explicit Conversion (Casting)",
                    "Variables"
                }
            },
            new()
...
END.",
            ...
            new()
            {
                ...
                Prerequisites = new List<string>
                {
                    "Substring", "StartsWith and EndsWith", "While Loops", "If statements", "Variables",
            ...
            new()
            {
                ...
                {
                    "ServerSocket", "Socket", "Thread", "SicherheitsZentrale", "BenutzerVerwaltung", "Alarmanlage",
                    "ProtokollLog", "ListT", "String"
                },
                Prerequisites = new List<string>
                {
                    "Inheritance Basics", "Method Overriding", "While Loops", "Booleans", "If-Else statements",
...
END.",
            ...
            new()
            {
                ...
                NoUMLAutoScale = true,
                AuxiliaryIds = new List<string>
                    { "ListT", "LocalDate", "Serial", "String", "GepaeckSchleuse", "FlughafenVerwaltungMock" },
                Prerequisites = new List<string>()
            },
            new()
            {
                ...
                AuxiliaryIds = new List<string>
                {
                    "ListT", "LocalDate", "Serial", "String", "Passagier", "Flug", "FlughafenVerwaltungPartial",
                    "Gepaeckstueck"
                },
                Prerequisites = new List<string>()
            }
